...
## "(ql:quickload :coalton/benchmarks :silent t)" fails, saying there's no
## package "TRIVIAL-BENCHMARK", while "(ql:quickload :trivial-benchmark)" works.
##
## Go figure!!! (package name is "org.shirakumo.trivial-benchmark"...)
get-ql-libs:
	...
	$(SBCL_COMP) --load "$(QUICKLISP_HOME)/setup.lisp" \
			...
			--eval "(ql:quickload :trivial-benchmark)" \
